...
**Every prospect gets a score from 0 to 100 based on how well they match your ICP. Anything under 50 gets filtered out — you can still see them, but Guhan won't message them.**

Match score = how closely the prospect matches your title, location, industry, and company size filters.
