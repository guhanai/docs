...
Signal-driven searches run against Guhan's own data pipelines. You pay per **landed prospect** (1 credit), not per signal-hit. See [Plans and credits](/workspace-settings/plans-and-credits) for the full breakdown.
