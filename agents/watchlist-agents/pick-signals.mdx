...
description: Which buying signal to pick for which sales motion — practical guidance for picking triggers.
---

**Not sure which signal to use? Ask yourself: "What just happened in the prospect's world that makes them more likely to say yes to my pitch?" That's your signal.**

Pick the wrong signal → right person, wrong timing. Pick the right one → reply rates jump.
