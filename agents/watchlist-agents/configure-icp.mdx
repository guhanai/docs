...
description: Configure your Ideal Customer Profile — job title, location, industry, company size. The filters that drive every search Guhan runs.
---

**Your ICP is a plain-English description of your ideal customer — title, location, industry, company size. Guhan uses it to search its data pipelines and to score every prospect it finds.**

ICP stands for **Ideal Customer Profile**. Get this right and Guhan finds the right people. Get it wrong and every message goes to the wrong audience.
