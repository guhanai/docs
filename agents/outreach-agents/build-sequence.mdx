...
**A sequence is the step-by-step flow — invite, wait, DM, wait, email, wait, nudge. Two views to build it: a simple list, or a visual canvas for branching flows.**

The sequence runs the same way for every prospect. Get it right once, it runs forever.
