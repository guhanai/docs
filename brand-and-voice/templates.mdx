...
description: Reusable message briefs — pick from 10 built-in defaults or write your own. Guhan personalizes the wording per prospect.
---

**A template is a re-usable brief — a short paragraph telling Guhan WHAT a message should say. Guhan writes the actual words per prospect.**

Not a fill-in-the-blank template. You describe the intent. Guhan does the writing.
