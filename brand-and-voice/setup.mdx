...
**Set up Brand & Voice once. Guhan uses it forever. 15 minutes here saves you rewriting every message later.**

Every field maps to something Guhan will (or won't) do when writing to prospects.
