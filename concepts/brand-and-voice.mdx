...
See [Write message templates](/guides/write-message-templates) for the deep dive.
...
<CardGroup cols={2}>
  <Card title="Set up Brand & Voice" icon="palette" href="/guides/brand-and-voice">
    Step-by-step configuration walkthrough.
  </Card>
  <Card title="Personalization" icon="wand-magic-sparkles" href="/concepts/personalization">
