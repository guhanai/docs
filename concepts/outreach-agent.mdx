...
See [Plans and credits](/concepts/plans-and-credits) for the full breakdown.

## Learn more

<CardGroup cols={2}>
  <Card title="Create an Outreach Agent" icon="plus" href="/guides/create-outreach-agent">
    Step-by-step: audience + sequence + sender.
  </Card>
  <Card title="Build the sequence" icon="diagram-project" href="/guides/build-sequence">
