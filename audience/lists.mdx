---
title: Lists
description: Lists are prospect buckets — Watchlist Agents fill them, Outreach Agents drain them.
---

**A List is just a bucket of prospects. Watchlist Agents put people in. Outreach Agents take people out. That's the whole idea.**

Lists let you separate different audiences — e.g., "Enterprise VPs" in one bucket and "SMB owners" in another.
...
<CardGroup cols={2}>
  ...
  <Card title="Outreach Agent" icon="paper-plane" href="/agents/outreach-agents/overview">
