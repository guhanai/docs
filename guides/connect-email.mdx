...
You can also connect a calendar without a sender (e.g., Cal.com booking URL). Details on [the Meetings concept page](/concepts/meetings).
...
<CardGroup cols={2}>
  <Card title="Sender accounts" icon="paper-plane" href="/concepts/sender-accounts">
