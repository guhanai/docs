...
- **Rewrite now** — see [Build a sequence](/guides/build-sequence) for the full walkthrough
...
<CardGroup cols={2}>
  <Card title="Build the sequence" icon="pen-to-square" href="/guides/build-sequence">
    Deep-dive into the canvas + stair views.
  </Card>
  <Card title="Launch checklist" icon="rocket" href="/guides/launch-outreach">
