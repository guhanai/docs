...
**Connect Gmail or Outlook so Guhan can send outbound email AND read replies as they come back.**

Email adds a lot of daily volume on top of LinkedIn (~500 sends/day vs. 25-30). Replies land back in your real inbox the way they always do — plus in Guhan's Inbox so nothing gets missed.
...
<AccordionGroup>
  <Accordion title="'Access denied' from Google">
    Some Google Workspace admins restrict third-party OAuth. Ask your admin to allow Guhan for the tenant. After that, any user can connect.
  </Accordion>
