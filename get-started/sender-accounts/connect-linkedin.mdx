...
**Connect your LinkedIn once. Guhan uses it to send messages on your behalf — invites, DMs, comments, reactions, profile views.**

LinkedIn is one of three channels Guhan supports (LinkedIn / Email / WhatsApp). Connect it from the launch screen's "How to reach them" popup, from the banner on your Outreach Agent after launch, or here in Settings.

<Note>
  Your LinkedIn is only used for **sending**. Finding prospects is done entirely by Guhan's own data pipelines — your account never runs discovery searches.
</Note>
