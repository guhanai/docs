...
**Open the Inbox once a day. Filter to what needs you. Approve, edit, or take over each thread. Aim to clear it in 10-15 minutes.**

This page is the daily rhythm — the exact clicks to move through your Inbox fast.
...
<CardGroup cols={2}>
  <Card title="AI reply drafts" icon="wand-magic" href="/inbox/ai-reply-drafts">
