...
**Common gotcha:** some Microsoft 365 tenants restrict third-party OAuth. Your admin may need to approve Guhan once for the tenant. After that, any user can connect.
